...
<div>
<span><a href="t2.php"><input type="button" value="Print Cv" style="width:15%;height:5%;background-color: pink"></a>

<a href="t2.php" download="t2.doc"> <input type="button" value="Download"style="width:15%;height:5%;background-color:pink"><span class="network-name"></span></a>
