...
while($row = mysqli_fetch_array($result))
{
 ...
 echo " Address :".$row['address']."<br>".$row['city']."<br>".$row['state']."<br>".$row['postal']."<br>".$row['country']."<br> DOB :".$row['birthday']."<br> Birthplace :".$row['birthPlace']."<br> Nationality :".$row['nationality']."<br> Contact :".$row['countryCode']." - ".$row['mobile']."<br> Email id :".$row['email'];
}
?>
...
<div>
<span><a href="t7.php"><input type="button" value="Print Cv" style="width:15%;height:5%;background-color: pink"></a>

<a href="t7.php" download="t7.doc"> <input type="button" value="Download"style="width:15%;height:5%;background-color:pink"><span class="network-name"></span></a>
