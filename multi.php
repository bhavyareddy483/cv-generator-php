<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01//EN" "http://www.w3.org/TR/html4/strict.dtd">
    ...
    <title>Detailed Resume Form</title>
...
<!-- <label>Name:<span><input type="text" style="width:125px;font-weight: bold;color:black;text-align: left" name="name" size="21" value=" "></span></label>          
 -->
          <li class="form-line" data-type="control_address" id="id_215">
              ...
              <table summary="" class="form-address-table">
                <tbody>
                  <tr>
                    <td colSpan="2">
                      <span class="form-sub-label-container " style="vertical-align:top">
                        <input type="text" id="addr" name="address" class="form-textbox form-address-line"  placeholder="house/flat number and stree address" data-component="address_line_1" aria-labelledby="label_215 sublabel_215_addr_line1" value=" "/>
                  ...
                  <tr>
                    <td>
                      <span class="form-sub-label-container " style="vertical-align:top">
                        <input type="text" id="input_215_city" name="city" class="form-textbox form-address-city" size="21"  data-component="city" aria-labelledby="label_215 sublabel_215_city" value=" "/>
                    ...
                    <td>
                      <span class="form-sub-label-container " style="vertical-align:top">
                        <input type="text" id="input_215_state" name="state" class="form-textbox form-address-state" size="22"  data-component="state" aria-labelledby="label_215 sublabel_215_state" value=" " />
                    ...
                    <tr>
                      <td>
                        <span class="form-sub-label-container " style="vertical-align:top">
                          <input type="text" id="input_215_postal" name="postal" class="form-textbox form-address-postal" size="10" placeholder="6 digits"  data-component="zip" aria-labelledby="label_215 sublabel_215_postal" value=" "/>
                      ...
                      <td>
                        <span class="form-sub-label-container " style="vertical-align:top">
                          <select class="form-dropdown form-address-country noTranslate" name="country" id="input_215_country" data-component="country" required="" aria-labelledby="label_215 sublabel_215_country"  value=" ">
            ...
            <li class="form-line" data-type="control_textbox" id="id_18">
              ...
              <div id="cid_18" class="form-input">
                <input type="text" id="input_18" name="birthPlace" data-type="input-textbox" class="form-textbox" size="20"  placeholder=" " data-component="textbox" aria-labelledby="label_18"  value=" " />
   ...
   <select name="countryCode" id=""  value=" ">
  ...
  <optgroup label="Other countries">
    ...
    <option data-countryCode="ZW" value="263">Zimbabwe (+263)</option>
                  ...
                  <span class="form-sub-label-container " style="vertical-align:top" data-input-type="phone">
                    <input type="tel" id="input_226_phone" name="mobile" class="form-textbox" size="12"  data-component="phone" maxlength="11" aria-labelledby="label_226 sublabel_226_phone"  value=" "/>
            ...
            <li class="form-line" data-type="control_email" id="id_13">
              ...
              <div id="cid_13" class="form-input">
                <input type="email" id="input_13" name="email" class="form-textbox validate[Email]" size="30"  placeholder="ex: myname@example.com" data-component="email" aria-labelledby="label_13"  value=" "/>
...
School percent:
<input type="text" id="schoolper" style="width:150px" name="spercent"  value=""/> 
<br><br>
PUC(12th) :  
 <select name="puc"  value="">  
...
<option value="Bcom">Bcom</option>  
 ...
 <option value="B.Optom">B.Optom(Batchelor of Optemetry)</option>
  ...
  <textarea class="form-control" rows="5" name="skills1" placeholder="Enter the skills "id="skillsnew" value=" "></textarea>
</div>
...
<div class="collapse" id="collapseExample1">
  <div class="card card-body">
    <br>
    <label>Position:<span><input type="text" style="width:125px;font-weight: bold;text-align: left" name="pos1" size="21"  value=" "></span></label>
    <label>Company:<span><input type="text" style="width:125px;font-weight: bold;text-align: left" name="co1" size="21"  value=" "></span></label>
  </div>
...
<div class="collapse" id="collapseExample2">
  <div class="card card-body">
    <br>
    <label>Position:<span><input type="text" style="width:125px;font-weight: bold;text-align: left" name="pos2" size="21"  value=" "></span></label>
    <label>Company:<span><input type="text" style="width:125px;font-weight: bold;text-align: left" name="co2" size="21"  value=" "></span></label>
  </div>
...
<div class="collapse" id="collapseExample3">
  <div class="card card-body">
    <br>
    <label>Position:<span><input type="text" style="width:125px;font-weight: bold;text-align: left" name="pos3" size="21"  value=" "></span></label>
    <label>Company:<span><input type="text" style="width:125px;font-weight: bold;text-align: left" name="co3" size="21"  value=" "></span></label>
  </div>
