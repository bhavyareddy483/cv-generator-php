...
<h2><u><b>Education Qualification</b></u></h2>
<?php
$result = mysqli_query($con,"SELECT * FROM ans WHERE email = '".$_SESSION['email']."'");
while($row = mysqli_fetch_array($result))
{
...
<h2><u><b>Skills And Ability</b></u></h2>
<?php
$result = mysqli_query($con,"SELECT * FROM ans WHERE email = '".$_SESSION['email']."'");
while($row = mysqli_fetch_array($result))
{
...
<div>
<span><a href="t6.php"><input type="button" value="Print Cv" style="width:15%;height:5%;background-color: pink"></a>

<a href="t6.php" download="t6.doc"> <input type="button" value="Download"style="width:15%;height:5%;background-color:pink"><span class="network-name"></span></a>
