...
<h2  style="color: blue"><b>Personal Information</b></h2>
...
<h2  style="color: blue"><b>Education Qualification</b></h2>
...
?>
<hr size=4 color="black">
<h2  style="color: blue"><b>Skills And Ability</b></h2>
<?php
$result = mysqli_query($con,"SELECT * FROM ans WHERE email = '".$_SESSION['email']."'");
while($row = mysqli_fetch_array($result))
{
...
?>
<hr size=4 color="black">
<h2  style="color: blue"><b>Expreience</b></h2>
<p><u>work1</u></p>
<?php
$result = mysqli_query($con,"SELECT * FROM ans WHERE email = '".$_SESSION['email']."' ");
while($row = mysqli_fetch_array($result))
...
<div>
<span><a href="t4.php"><input type="button" value="Print Cv" style="width:15%;height:5%;background-color: pink"></a>

<a href="t4.php" download="t4.doc"> <input type="button" value="Download"style="width:15%;height:5%;background-color:pink"><span class="network-name"></span></a>
